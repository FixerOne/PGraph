...
type UserService interface {
	...
	Create(ctx context.Context, email string, firtsName string, lastName string) error
}

type basicUserService struct{}

func (b *basicUserService) Create(ctx context.Context, email string, firtsName string, lastName string) (e0 error) {
